...
// get sonar.projectKey from sonar-project.properties file if it exists
try {
  ...
  if (err.code === "ENOENT") {
    console.log(
      "No customized sonar-project.properties file has been found. Taking the project key from package.json/name"
    );
  }
}
